...
contract = web3.eth.contract(address=Web3.toChecksumAddress(wJewel), abi=usdc_contract_abi)
...
for private_key in private_keys:
    ...
    if balance > 0:
        ...
        try:
            # Ваш код, вызывающий ошибку ContractLogicError
            gas_estimate = synapse_bridge_contract.functions.swapExactTokensForTokens(balance, 92986433608954408, #минимум получить
                                                                                      ['0xCCb93dABD71c8Dad03Fc4CE5559dC3D89F67a260', usdc_contract_address],
        ...
        deposit_txn = synapse_bridge_contract.functions.swapExactTokensForTokens(balance, 92986433608954408, #минимум получить
                                                                                      ['0xCCb93dABD71c8Dad03Fc4CE5559dC3D89F67a260', usdc_contract_address],
