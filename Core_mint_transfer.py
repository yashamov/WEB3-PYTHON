...
BRIDGE_CONTRACT_ADDRESS = '0x5c5979832A60c17bB06676fa906bEdD1A013e18c'
...
assert w3.isConnected(), 'Подключение к Core не удалось'
...
def mint_and_approve(YOUR_PRIVATE_KEY):
    ...
    SPENDER_ADDRESS = '0x5c5979832A60c17bB06676fa906bEdD1A013e18c'
...
def transferNFT(YOUR_PRIVATE_KEY, token_id):
    ...
    transfer_nft_amount = w3.toWei(0.5, 'ether')
